...
export namespace JournalsView {
    export class State {
        ...
        constructor({ module }: { module: ModuleFlux }) {
            this.module = module
        }
    }
    ...
    export class View implements VirtualDOM {
        ...
        constructor({ state, ...rest }: { state: State }) {
            ...
            const journalSelected$ = new BehaviorSubject<string>(
                this.state.module.journals[0].title,
            )
            this.children = [
                ...
                child$(
                    journalSelected$.pipe(
                        map((title) =>
                            this.state.module.journals.find(
        ...
        selectJournalView(
            journalSelected$: BehaviorSubject<string>,
        ): VirtualDOM {
    ...
    export function popupModal({ module }: { module: ModuleFlux }) {
