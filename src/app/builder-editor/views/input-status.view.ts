...
export namespace InputStatusView {
    ...
    export class State {
        ...
        constructor({
            ...
            this.tabState = new Tabs.State(
                [new DataTab(), new ConfigTab()],
                selectedTabId$,
            )

            this.configStatus = mergeConfiguration(
                mdle.configuration.data,
                adaptedInput.configuration,
            )
    ...
    export class View implements VirtualDOM {
        ...
        constructor({
            ...
            const expandedNodesExpectation$ = new BehaviorSubject<
                Array<string>
            >(['optional', 'required'])
    ...
    function dataHeaderView(status: ExpectationStatus<any>) {
        ...
        return {
            ...
            children: [{ class: classes }, { innerText: 'data' }],
        }
    }
    ...
    function configurationHeaderView(status: ConfigurationStatus<unknown>) {
        ...
        if (
            status instanceof ConsistentConfiguration &&
            status.intrus.length > 0
        ) {
        ...
        return {
            class: 'd-flex align-items-center px-2',
            children: [icon, { innerText: 'configuration' }],
        }
    }
}
