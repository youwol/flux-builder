...
export namespace ExpectationView {
    ...
    export function parseReport(rootStatus: ExpectationStatus<any>) {
        const parseNode = (status: ExpectationStatus<any>) => {
            ...
            if (
                ...
                !(status.expectation instanceof Contract)
            ) {
    ...
    export class State {
        ...
        constructor({
            ...
            const requiredRootNode =
                treeNode.children && treeNode.children.length > 0
                    ? treeNode.children[0]
                    : new ExpectationNode({
                          name: 'No required conditions defined',
                          children: undefined,
                          isRealized: true,
            ...
            const optionalRootNode =
                treeNode.children && treeNode.children.length > 1
                    ? treeNode.children[1]
                    : new ExpectationNode({
                          name: 'No optional conditions defined',
                          children: undefined,
                          isRealized: true,
                          evaluatedFrom: undefined,
                      })
            ...
            this.children = [
                {
                    ...
                    children: [
                        {
                            class: this.state.status.succeeded
                        ...
                        },
                        {
                            class: 'px-2',
                            innerText:
                                this.state.status.expectation.description,
                        },
                    ],
                },
                {
                    class: 'pl-2 flex-grow-1 overflow-auto ',
    ...
    function headerView(
        _: ImmutableTree.State<ExpectationNode>,
            ...
            return {
                ...
                children: [
                    ...
                    { innerText: node.name, class: 'fv-text-primary px-2' },
                    {
                        ...
                        innerText: 'All of the following:',
                    },
                ],
            }
        }
            ...
            return {
                ...
                children: [
                    ...
                    { innerText: node.name, class: 'fv-text-primary px-2' },
                    {
                        tag: 'i',
                        class: 'fv-text-primary',
                        innerText: 'Any of the following:',
                    },
                ],
            }
        }
