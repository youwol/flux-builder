...
from youwol.app.environment.models_project import BrowserApp, Execution, BrowserAppGraphics, OpenWith, Link
...
app_icon = f"url('{assets_dir}/old_flux_builder_app.svg')"
file_icon = f"url('{assets_dir}/old_flux_builder_file.svg')"
